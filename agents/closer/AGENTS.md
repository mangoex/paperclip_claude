...
**Semilla de IA en mensaje 2:** Si el giro del negocio lo permite, incluye una mención sutil de servicios de IA según la tabla de "Semillas de IA por giro" del skill `sales-copywriting`. Esto planta la semilla para el Tier 3 (Transformación IA) de la propuesta.
...
- **Si pregunta por IA/chatbot/automatización** (abrió el tier 3): Escalar a CEO como prioridad alta — es un prospecto caliente para servicios de IA.
...
| **Prospecto pregunta por IA/chatbot** | **Ticket URGENTE para CEO: "Prospecto interesado en IA — {NOMBRE_NEGOCIO}"** |
...
**Respuestas del prospecto:** {RESUMEN_INTERACCIONES}
...
- ✅ La firma SIEMPRE dice "Humanio — Inteligencia Artificial para negocios"
...
- **Si prospecto pregunta por IA/chatbot/automatización: ticket URGENTE para CEO**
