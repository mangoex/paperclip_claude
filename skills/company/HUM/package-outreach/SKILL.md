...
- Usar el nombre del negocio y del contacto (si se tiene)
- Mencionar algo específico del negocio
- Tono profesional pero cercano

### 2. Diagnóstico breve
- 2-3 hallazgos clave de la auditoría del Qualifier
- Enfocarse en oportunidades, no en problemas
- Usar datos reales del análisis

### 3. Presentación de los 3 paquetes

STARTER — $27 USD/mes (~{moneda local})
- Página web profesional moderna
- Enlace directo a WhatsApp
- Formulario de contacto
- Diseño responsive
- Optimizada para Google

PRO — $47 USD/mes (~{moneda local})
- Todo lo del plan Starter
- Chatbot WhatsApp inteligente
- Responde horarios, precios, ubicación
- Atención 24/7 automatizada
- RECOMENDADO para {giro}

BUSINESS — $97 USD/mes (~{moneda local})
...
Seguimiento amigable + recordar beneficio principal

### WhatsApp (Mensaje 3 — Closer, día 7)
Último contacto + ofrecer llamada rápida + respetar decisión
